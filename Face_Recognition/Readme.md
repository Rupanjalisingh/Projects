...
* Uses `MLPClassifier`
* Uses `train_test_split(test_size=0.25)` (not 60–40)
...
* Small k → insufficient features
* Large k → better accuracy
* Very large k → risk of overfitting
...
3. If max probability < threshold → classify as "Not Enrolled"
